...
import com.example.l4_andro.databinding.ActivityMainBinding
...
//        }
    ...
    private fun initApp() {
        ...
        appBarConfig =
            AppBarConfiguration(setOf(R.id.photoListFragment, R.id.main_frag, R.id.list_frag), drawerLayout)
